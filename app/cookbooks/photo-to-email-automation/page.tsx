    ...
    <div className="max-w-5xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="prose prose-gray max-w-none space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-gray-900">Manufacturing:</strong>
                    <span className="text-gray-700"> Serial number tracking and part recall notifications</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-gray-100 rounded-lg">
                  ...
                  <div>
                    <strong className="text-gray-900">Auto service:</strong>
                    <span className="text-gray-700"> VIN plate photos triggering service reminders</span>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-gray-900">Medical devices:</strong>
                    <span className="text-gray-700"> Compliance alerts based on equipment ID plates</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-gray-100 rounded-lg">
                  ...
                  <div>
                    <strong className="text-gray-900">Appliances & home systems:</strong>
                    <span className="text-gray-700"> Warranty, upgrade, or service eligibility detection</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="mt-6 p-4 bg-gray-100 rounded-lg text-center">
              <p className="text-lg font-medium text-gray-900">One image. One workflow. Endless automation.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-lg p-6 border">
            <p className="text-gray-800 mb-4">With Model HQ, we built an automated agent workflow that takes:</p>
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-600" />
                <span className="text-gray-700">Cross-checks technical documents like the R22 phaseout guide</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-600" />
                <span className="text-gray-700">Identifies at-risk units</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-green-600" />
                <span className="text-gray-700">
            ...
            <p className="text-center text-sm text-gray-600 font-medium">—all in seconds.</p>
          </div>
        </section>
                ...
                <div className="flex-1">
                  ...
                  <Card className="bg-gray-50 border">
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <Download className="h-5 w-5 text-gray-600 mt-1 flex-shrink-0" />
                          <span className="text-gray-800">
                            ...
                            <div className="my-4 bg-blue-100 p-4 rounded-lg mt-4">
                              <img
                                ...
                                alt="all process"
                                className="rounded-lg shadow-md border max-w-md w-full"
                              />
                            </div>
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-gray-800">
                            ...
                            .CSV called <code className="bg-gray-100 px-2 py-1 rounded">AC Unit Data</code> you will
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            ...
                            <span className="text-gray-800">Go to '+ Inputs'</span>
                          </div>
                          <div className="flex items-start gap-3">
                            <span className="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center text-sm font-semibold text-gray-800 mt-0.5 flex-shrink-0">
                              2
                      ...
                      <div className="border-l-4 border-l-blue-500 pl-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-700">
                          ...
                          <div>
                            ...
                            <code className="bg-gray-100 px-2 py-1 rounded">What is the model number?</code>
                          </div>
                          <div>
                            <strong>Choose for Context:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">User Image</code>
                          </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="border-l-4 border-l-green-500 pl-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-700">
                          ...
                          <div>
                            <strong>Enter in Instruction:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">the model number</code>
                          </div>
                          <div>
                            <strong>Choose for Context:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">Vision_1</code> (We are asking the Extract
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="border-l-4 border-l-indigo-500 pl-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-700">
                          ...
                          <div>
                            <strong>Enter in Instruction:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">ac_data</code>
                          </div>
                          <div>
                            <strong>Choose for Context:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">Updated_AC_Unit_Data</code>
                          </div>
                          <div className="mt-2 text-gray-600 italic">
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-6">
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg">
                          ...
                          <p className="text-gray-800 text-sm mt-2">A second query checks:</p>
                      ...
                      <div className="space-y-6">
                        <div className="border-l-4 border-l-purple-500 pl-4">
                          ...
                          <div className="space-y-2 text-sm text-gray-700">
                            ...
                            <div>
                              <strong>Enter in Instruction (must enter exactly):</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">R22 technical doc</code>
                            </div>
                            <div>
                              <strong>Choose for Context:</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">R22_Technical Document</code>
                            </div>
                            <div className="mt-2 text-gray-600 italic">
                      ...
                      <div className="space-y-6">
                        <div className="border-l-4 border-l-teal-500 pl-4">
                          ...
                          <div className="space-y-2 text-sm text-gray-700">
                            ...
                            <div>
                              <strong>Enter in Instruction (must enter exactly):</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">customer name</code>
                            </div>
                            <div>
                              <strong>Choose for Context:</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">Main Input</code>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="border-l-4 border-l-blue-500 pl-4">
                          ...
                          <div className="space-y-2 text-sm text-gray-700">
                            ...
                            <div>
                              <strong>Enter in Instruction (must enter exactly):</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">email address</code>
                            </div>
                            <div>
                              <strong>Choose for Context:</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">Main Input</code>
                  ...
                  <Card className="bg-gray-50 border">
                    <CardContent className="p-6">
                      ...
                      <div className="bg-gray-100 p-4 rounded-lg mb-6">
                        <p className="text-gray-800 mb-2">Personalized with:</p>
                      ...
                      <div className="space-y-6">
                        <div className="border-l-4 border-l-orange-500 pl-4">
                          <h4 className="font-semibold text-gray-900 mb-3">Row 10:</h4>
                          <div className="space-y-2 text-sm text-gray-800 mb-4">
                            ...
                            <div>
                              <strong>Choose for Context:</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">Vision 1</code>
                            </div>
                          </div>
                        ...
                        <div className="border-l-4 border-l-green-500 pl-4">
                          <h4 className="font-semibold text-gray-900 mb-3">Row 11:</h4>
                          <div className="space-y-2 text-sm text-gray-800 mb-4">
                            <div>
                              From the Services Menu, select <strong>'Chat'</strong>
                            </div>
                            ...
                            <div>
                              <strong>Choose for Context:</strong>{" "}
                              <code className="bg-gray-100 px-2 py-1 rounded">Chat_11</code>
                            </div>
                          </div>
                          ...
                          <div className="bg-gray-100 p-4 rounded-lg mt-4">
                            <p className="text-gray-800 text-sm">A second chat step formats the email:</p>
                            <ul className="list-disc list-inside text-gray-700 text-sm mt-2 space-y-1">
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="border-l-4 border-l-blue-500 pl-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-700">
                          ...
                          <div>
                            <strong>Enter in Instruction (must enter exactly):</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">{`{{email_address}}`}</code>
                          </div>
                          <div>
                            <strong>Choose for Context:</strong>{" "}
                            <code className="bg-gray-100 px-2 py-1 rounded">Chat_11</code>
                ...
                <div className="flex-1">
                  ...
                  <Card className="bg-gray-50 border">
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-4">
                        <div className="border-l-4 border-l-green-500 pl-4">
                          <h4 className="font-semibold text-gray-900 mb-2">Main Input:</h4>
                          <div className="space-y-2 text-sm text-gray-700">
                            <div>
                              For the <strong>Text input in Main Input</strong>, enter your name and email address so
                              you can test: <code className="bg-gray-100 px-2 py-1 rounded">[Your Name] [email]</code>
                            </div>
                            <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg">
                          <p className="text-gray-800 text-sm">You will see the following results</p>
