        ...
        <div className="space-y-8">
          ...
          <section id="user-content">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              storage sites, perform intelligent document processing, generate data sets based on your own content,
              train AI models based on this content and so on ("Your User Content"). We only have access to Account
              Information you give us and the type of models you are downloading. Once downloaded, unless you give us
              permission explicitly, provide us with access, or by downloading other apps in the future that allows such
              access, we do not access, store and organize or find information around Your User Content – we only supply
              you with artificial intelligence, machine learning or natural language processing algorithms that you or
              we may apply to Your User Content the purpose of which is to be used locally on-device or shared via
              private APIs in your local environment ("Services").
            </p>
          </section>
          ...
          <section id="device-information">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              devices. Your devices (depending on their settings) may also transmit location information to the
              Services. In addition, we may use third party services that may use some of this data to help us provide
              our Services.
            </p>
          </section>
          ...
          <section id="processing-basis">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              advance or require that our partners obtain such consent.
            </p>
          </section>
          ...
          <section id="trusted-third-parties">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              your information to perform tasks related to our provision of Services, and we'll remain responsible for
          ...
          <section id="law-order">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              injury; (c) prevent fraud or abuse of our business or our users; (d) protect our rights, property, safety,
          ...
          <section id="data-control">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 ml-4">
              ...
              <li>
                <strong>Change or correct personal data.</strong> You can manage your account and the content contained
                in it, as well as edit some of your personal data, through your accounts setting page.
              </li>
              <li>
                <strong>Access and take your data elsewhere.</strong> You can access your personal data from your
                account and you can download a copy of Your User Content in a machine readable format at any time. You
                can also ask us for a copy of personal data you provided to us or that we've collected, the business or
                commercial purpose for collecting it, the types of sources we got it from, and types of third parties
                we've shared it with.
              </li>
              <li>
                <strong>Object to the processing of your personal data.</strong> Depending on the processing activity,
          ...
          <section id="changes">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              at any time and you should check this Privacy Policy periodically. Your continued use of the Service after
              ...
              material changes to this Privacy Policy, we will notify you either through the email address you have
